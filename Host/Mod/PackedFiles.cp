...
**)
	...
	PROCEDURE (d: Directory) FileList (floc: Files.Locator): Files.FileInfo;
		VAR pi, fi, tfi, nfi, last: Files.FileInfo; diff: INTEGER; caseSens: BOOLEAN; firstRes: INTEGER;
	BEGIN
	...
	PROCEDURE (d: Directory) LocList (floc: Files.Locator): Files.LocInfo;
		VAR pi, li, nli, last: Files.LocInfo; diff: INTEGER; caseSens: BOOLEAN; firstRes: INTEGER;
	BEGIN
